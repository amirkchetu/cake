...
<head>
    ...
    <?= $this->fetch('css') ?>
    <?= $this->fetch('script') ?>
	<link id="bs-css" rel="stylesheet" href="/cake/charisma/css/bootstrap-cerulean.min.css">
	...
	<?= $this->Jquery->jqueryLoad('var $ = jQuery.noConflict();');?>
<style>
body > iframe {
  margin-right: -39px;
    ...
    <div class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-inner">
            ...
            <a class="navbar-brand" href="index.html">
				<?php echo $this->Html->image('logo20.png', array('alt' => 'Domains & Hosting','class'=>'hidden-xs'));?>
            ...
            <ul class="collapse navbar-collapse nav navbar-nav top-menu">
                <li class="dropdown">
                    <a href="#" data-toggle="dropdown"><i class="glyphicon glyphicon-random"></i> Shortcuts <span
                            class="caret"></span></a>
...
<div class="row">
    ...
    <footer class="row">
        <p class="col-md-9 col-sm-9 col-xs-12 copyright">&copy; <a href="http://madmak787.wordpress.com" target="_blank">MAK</a> 2015</p>

        <p class="col-md-3 col-sm-3 col-xs-12 powered-by">Powered by: <a
                href="#">Domain&Hosting Team</a></p>
    </footer>
